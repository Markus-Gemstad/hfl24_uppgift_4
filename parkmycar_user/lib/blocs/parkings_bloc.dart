...
class ParkingsBloc extends Bloc<ParkingsEvent, ParkingsState> {
  final ParkingHttpRepository repository;
  final ParkingSpaceHttpRepository repositorySpace;
  ...
  Future<void> onLoadParkings(int personId, Emitter<ParkingsState> emit) async {
    try {
  ...
  Future<List<Parking>> _loadParkings(int personId) async {
    var parkings =
